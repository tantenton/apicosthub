...
export default function GpuVsApiPage() {
  return (
    <div className="w-full min-h-screen bg-[#090B10] text-[#E2E8F0] py-8 md:py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-xs text-[#94A3B8] mb-6">
          ...
          <span>/</span>
          <span className="text-emerald-400 font-mono">gpu-vs-api-breakeven</span>
        </div>

        {/* Page Hero */}
        <div className="max-w-3xl mb-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#1E2538] bg-[#111520] px-3 py-1 text-xs text-amber-400 mb-3">
        ...
        <div className="my-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="surface-card rounded-2xl p-6 sm:p-8">
            <div className="flex items-center gap-2 text-xs uppercase tracking-wider text-emerald-400 mb-2">
